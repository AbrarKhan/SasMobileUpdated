 ...
 */
public class TutorialActivity extends SASBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        leftText = (Button) findViewById(R.id.left_text);
        rightText = (Button) findViewById(R.id.right_text);
        skipTutorial = (Button) findViewById(R.id.skip_tutorial);
