...
import com.sasmobile.utils.MapFragment;
 ...
 */
public class AnnouncementsFragment extends Fragment implements AnnouncementsAdapter.OnCareerItemClicked {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.announcements_fragments, container, false);
        ...
        mHeaderTitle.setText("Announcements");
        mAnnouncements = getResources().getStringArray(R.array.announcements_names);
        ...
        AnnouncementsAdapter eventsAdapter = new AnnouncementsAdapter(getActivity(), mAnnouncementsList);
    ...
    private void createContactsList() {
        ...
        mAnnouncementsList = new ArrayList<Announcements>();

        for (int i = 0; i < mAnnouncements.length; i++) {
            Announcements announcements = new Announcements();
            announcements.setAnnouncementsName(mAnnouncements[i]);
    ...
    public void onItemClick(int position) {
        Toast.makeText(getActivity(), "carreer fag",Toast.LENGTH_SHORT).show();
    }

    @Override
    public void onAddressClick(int position) {
        Toast.makeText(getActivity(), "carreer fag add",Toast.LENGTH_SHORT).show();
        Fragment fragment = null;
        FragmentTransaction ft = getActivity().getSupportFragmentManager().beginTransaction();
        fragment = MapFragment.newInstance(23.5839, 58.3886);
