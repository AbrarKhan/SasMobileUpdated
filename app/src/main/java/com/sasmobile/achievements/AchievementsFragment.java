 ...
 */
public class AchievementsFragment extends Fragment implements AchievementsAdapter.OnNewsItemClicked {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mHeaderTitle.setText("Achievements");
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.news_list);
        mAchievements = getResources().getStringArray(R.array.achievements_names);
        createContactsList();
        ...
        AchievementsAdapter productServicesAdapter = new AchievementsAdapter(getActivity(), mAchievementsList);
    ...
    private void createContactsList() {
        ...
        mAchievementsList = new ArrayList<Achievements>();

        for (int i = 0; i < mAchievements.length; i++) {
            Achievements achievements = new Achievements();
            achievements.setmAchievements(mAchievements[i]);
            mAchievementsList.add(achievements);
    ...
    public void onItemClick(int position) {
        Toast.makeText(getActivity(), "news Click  " + mAchievements[position], Toast.LENGTH_SHORT).show();
