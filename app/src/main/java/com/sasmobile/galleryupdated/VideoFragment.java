...
public class VideoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mMip = new int[]{R.drawable.tutorial1,
                R.drawable.tutorial2,
                R.drawable.tutorial3,
                R.drawable.tutorial3
        };

        videoList = new int[]{R.raw.sample_video, R.raw.sample_video, R.raw.sample_video,
                R.raw.sample_video};
        createGalleryData();
        ...
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.video_fragment);
        GridLayoutManager gridLayoutManager = new GridLayoutManager(getActivity(), NO_OF_COLUMNS); //no of columns = 3
        recyclerView.setLayoutManager(gridLayoutManager);
        VideoAdapter videoAdapter = new VideoAdapter(getActivity(), mMip, galleryList);
    ...
    private void createGalleryData() {
        ...
        for (int i = 0; i < videoList.length; i++) {
            ...
            gallery.setVideoURL(videoList[i]);
